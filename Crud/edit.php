...
<body>
    ...
    include ('koneksi.php');
    $id = $_GET['id'];
    $query = "SELECT * FROM anggota WHERE id = Sid";
    ...
    <div class="container">
        ...
        <input type="hidden" name="id" value="<?php echo Srow['id']; ?>"> 
...
echo 'checked'; ?> required><label for="laki">Laki-laki</label>
                <input type="radio" name="jenis _kelamin" value="p" id="perempuan" <?php if ($row['jenis_kelamin'] ===
'p') echo
'checked'; ?> required><label for="perempuan">Perempuan</label>
            </div>
            <label for="alamat">Alamat: </label>
            <input type="text" name="alamat" id="alamat" value="<?php echo Srow['alamat']; ?>" required>
